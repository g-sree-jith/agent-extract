    ...
    def _prepare_agent_state(
        ...
        if basic_result:
            ...
            state: AgentState = {
                ...
                "raw_text": basic_result.raw_text or "",
                "ocr_text": basic_result.raw_text if basic_result.extraction_method == "image_ocr" else None,
                "image_data": None,
                "document_type": None,
                "confidence_score": 0.0,
                "detected_schema": None,
                "structured_data": dict(basic_result.structured_data) if basic_result.structured_data else {},
                "tables": list(basic_result.tables) if basic_result.tables else [],
                "entities": list(basic_result.entities) if basic_result.entities else [],
